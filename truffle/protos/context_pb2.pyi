...
class ContextEntry(_message.Message):
    ...
    content: str
    index: int
    def __init__(self, type: _Optional[_Union[ContextEntry.ContextEntryType, str]] = ..., content: _Optional[str] = ..., index: _Optional[int] = ...) -> None: ...
...
class PrevContext(_message.Message):
    ...
    def __init__(self, state: _Optional[_Mapping[str, str]] = ..., context: _Optional[_Iterable[_Union[ContextEntry, _Mapping]]] = ...) -> None: ...
